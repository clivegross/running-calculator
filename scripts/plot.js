          ...
          tooltip: {
            callbacks: {
              label: function(context) {
                ...
                return `duration: ${formatMinutes(xValue/4)}, speed: ${yValue.toFixed(1)}m/s, distance: ${(xValue/4*60*yValue/1000).toFixed(2)} km`;
              }
            }
          }
        }
            ...
            tooltip: {
              callbacks: {
                label: function(context) {
                  ...
                  const yValue = context.raw;
                  // return `${label}: ${formatSecondsToMinutes(value)}`;
                  return `duration: ${formatMinutes(xValue/4)}, pace: ${formatSecondsToMinutes(yValue)}/km, distance: ${(xValue/4/yValue*60).toFixed(2)} km`;
                }
              }
            }
          }
